...
import (
	...
	"github.com/xinliangnote/go-gin-api/internal/repository/admin"
...
{{range .OptionFields}}
func (qb *{{$queryBuilderName}}) Where{{call $.Helpers.Titelize .FieldName}}(p admin.Predicate, value {{.FieldType}}) *{{$queryBuilderName}} {
